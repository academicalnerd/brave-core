...
export const onCryptoDotComRefreshedDataReceived = (tickerPrices: object, losersGainers: object[], charts: object, isConnected: boolean, accountBalances: object, supportedPairs?: string[]) => {
  return action(types.REFRESHED_DATA_RECEIVED, { tickerPrices, losersGainers, charts, isConnected, accountBalances, supportedPairs })
}
